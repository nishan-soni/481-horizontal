    ...
    <>
      <div className="w-full flex flex-col justify-center items-center py-2">
        <div className="flex flex-row items-center justify-center w-full h-20 gap-4 bg-gren-200">
          ...
          <p className="font-bold text-lg">Degree Requirements</p>
        </div>
      </div>
      <div className="w-full flex flex-col justify-start items-start pl-10">
        <div className="flex-1 w-full flex flex-col gap-8 bg-red-20 text-lg font-light text-center">
          <Link className={` pl-4 py-2 rounded-2xl rounded-r-sm hover:font-normal hover:bg-stone-100 ease-in-out transition-all duration-300
            ${tab == "Overview" ? 'border-r-[6px] border-red-500  bg-red-50 text-red-500 font-normal' : ''}`}
            to="/"
            onClick={() => setTab("Overview")}
          >
            <div className="flex flex-row gap-2 items-center">
              <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.1 4H5c-.5 0-.9.4-.9.9V9c0 .5.4.9.9.9h4c.5 0 .9-.4.9-.9V5c0-.5-.4-.9-.9-.9Zm10 0H15c-.5 0-.9.4-.9.9V9c0 .5.4.9.9.9h4c.5 0 .9-.4.9-.9V5c0-.5-.4-.9-.9-.9Zm-10 10H5c-.5 0-.9.4-.9.9V19c0 .5.4.9.9.9h4c.5 0 .9-.4.9-.9v-4c0-.5-.4-.9-.9-.9Zm10 0H15c-.5 0-.9.4-.9.9V19c0 .5.4.9.9.9h4c.5 0 .9-.4.9-.9v-4c0-.5-.4-.9-.9-.9Z" />
              </svg>
          ...
          >
            <div className="flex flex-row gap-2 items-center">
              <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 8v8m0-8a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm0 8a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm8-8a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm0 0a4 4 0 0 1-4 4h-1a3 3 0 0 0-3 3" />
              </svg>
          ...
          >
            <div className="flex flex-row gap-2 items-center">
              <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-width="1.5" d="m8 10.9 7-3.2m-7 5.4 7 3.2M8 12a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Zm12 5.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Zm0-11a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z" />
              </svg>
