...
const Nav = () => {
  return (
    <div className="min-h-full w-full flex flex-col items-center py-6 px-3">
      <div className="flex flex-row items-center justify-center w-full h-20 gap-4">
        <img src={ucalgarylogo} alt="logo" className="object-contain h-full" />
        <p className="font-bold text-3xl">Degree Requirements</p>
      </div>
